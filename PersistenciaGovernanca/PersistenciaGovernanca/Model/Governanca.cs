...
namespace FURNAS.GestaoSPE.PersistenciaGovernanca.Model
{
    public class Governanca
    {
        ...
        public List<SPListItem> GetListGovernancaSPE(string urlGovernanca)
        {
        ...
        public SPWeb GetListGovernanca(string urlGovernanca)
        {
            using (SPSite site = new SPSite(urlGovernanca))
            {
                using (SPWeb web = site.OpenWeb())
        ...
        public SPWeb ListGovernanca(string urlGovernanca)
        {
            using (SPSite site = new SPSite(urlGovernanca))
            {
                using (SPWeb web = site.OpenWeb())
